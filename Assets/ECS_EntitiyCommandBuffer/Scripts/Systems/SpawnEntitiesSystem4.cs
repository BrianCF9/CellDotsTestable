...
{
    public class SpawnEntitiesSystem4 : SystemBase
    {
        ...
        protected override void OnUpdate()
        {
            ...
            Entities.ForEach((Entity _, int entityInQueryIndex, ref CellTag4 cellTag, ref NonUniformScale scale, in Translation translation) =>
            {
                ...
                if (cellTag.readyToSpawn && cellTag.actualTimeToGrowth >= cellTag.timeToGrowth)
                {
                        ...
                        ecb.AddComponent<CellTag4>(entityInQueryIndex, newEntity);
                        if (xyz == 0)
                        {
                            if (upOrDown == 0)
                        {
                        ...
                        ecb.SetComponent(entityInQueryIndex, newEntity, new CellTag4
                        {
